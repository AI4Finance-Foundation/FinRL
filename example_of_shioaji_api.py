...
for ticker in TAI_0050_TICKER:
    print(ticker)
    ticker_list = [ticker]
    df_raw = SinopacDownloader(start_date = TRAIN_START_DATE,
    ...
    processor = SinopacProcessor(API_KEY='3Tn2BbtCzbaU1KSy8yyqLa4m7LEJJyhkRCDrK2nknbcu', API_SECRET='Epakqh1Nt4inC3hsqowE2XjwQicPNzswkuLjtzj2WKpR')
    ...
    df_final = pd.concat([df_final, df_with_turbulence])
