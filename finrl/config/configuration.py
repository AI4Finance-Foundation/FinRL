...
class Configuration:
    ...
    def load_from_files(self, files: List[str]) -> Dict[str, Any]:
        ...
        # Keep this method as staticmethod, so it can be used from interactive
        # environments
        config: Dict[str, Any] = {}
    ...
    def load_config(self) -> Dict[str, Any]:
        ...
        """
        # Load all configs
        config: Dict[str, Any] = self.load_from_files(
    ...
    def _process_datadir_options(self, config: Dict[str, Any]) -> None:
        ...
        logger.info(
            "Using user-data directory: %s ...",
            config["user_data_dir"])

        config.update(
            {"datadir": create_datadir(config, self.args.get("datadir", None))}
        )
    ...
    def _process_runmode(self, config: Dict[str, Any]) -> None:
        ...
        if not self.runmode:
            ...
            self.runmode = (
                RunMode.DRY_RUN if config.get(
                    "dry_run", True) else RunMode.LIVE)
