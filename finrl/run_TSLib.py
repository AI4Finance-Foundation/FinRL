...
from finrl.config import FEATURE_COLS
...
# mt4 specific
parser.add_argument(
    "--data", type=str, required=False, default="mt4", help="dataset type"
)
parser.add_argument(
    "--start_date",
    type=str,
    required=False,
    default=TRADE_START_DATE,
    help="start datetime",
)
parser.add_argument(
    "--end_date", type=str, required=False, default=TRADE_END_DATE, help="end datetime"
)
parser.add_argument(
    "--ticker_list", type=str, required=False, default=FX_STUDY, help="ticker_list"
)
...
parser.add_argument(
    "--feature_columns", type=str, default=FEATURE_COLS, help="feature columns of FOREX"
)
parser.add_argument(
    "--features",
    type=str,
