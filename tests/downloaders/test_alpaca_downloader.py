...
def test_dayBar_download(ticker_list):
    ...
    # Then
    expected = pd.DataFrame([['2021-07-29 04:00:00', 144.66, 146.55, 144.58, 145.64, 56571097,
        414821, 145.806207, 'AAPL'],
       ['2021-07-30 04:00:00', 144.49, 146.33, 144.11, 145.86, 70291908,
        464977, 145.396798, 'AAPL'],
       ['2021-07-29 04:00:00', 2722.76, 2743.03, 2722.76, 2730.81,
        962833, 56703, 2732.943535, 'GOOG'],
       ['2021-07-30 04:00:00', 2710.22, 2715.4273, 2696.284, 2704.42,
